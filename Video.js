...
var Video = React.createClass({
	...
	playVideo: function(){
		if(!this.state.paused){ // pour pallier au probleme du curseur que l'on bouge pour choisir le temps
	...
	render: function(){
		return (
			<div>
				<video className="video" width={this.props.width} height={this.props.height} controls ref="Video" onLoadedMetadata={this.onLoadedMetadata} onTimeUpdate={this.onTimeUpdate}>
